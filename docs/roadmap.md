...
| **2027 H1** | Dual-wheel Q1 EDU | Official SDK 1.0 — deploy to physical units | **CES 2027** showcase |
| **2027+** | Biped Q1 + dexterous hand | Manipulation SDK track | Manipulation demos / EDU expand |
...
| **M4 — Official SDK 1.0** | 2027 | Physical deploy path documented; EDU customers run Sim2Real on Q1 |
...
v1.0.0      Official EDU SDK (physical robot)
```
...
Documented early so EDU buyers know the multi-year path:
